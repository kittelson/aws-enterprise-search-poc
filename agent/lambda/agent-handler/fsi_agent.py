...
class FSIAgent:
    ...
    def create_agent(self):
        ...
        anycompany_tool = Tool(name="Kittelson", func=self.tools_instance.kendra_search, description="Use this tool to answer questions about Kittelson.")
    ...
    def run(self, input):
        print("Running TSE Agent with input: " + str(input))
        try:
